...
import { createStory } from '@/lib/supabase/stories-admin';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        alert('There was an error creating the story. Please try again.');
      }
    } catch (error) {
      ...
      <DialogContent className="sm:max-w-2xl bg-card text-foreground border-accent/20 max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription className="text-center text-muted-foreground">
            Share a testimony or impactful story from your church community.
          </DialogDescription>
        </DialogHeader>
        ...
        {isSuccess ? (
          <div className="text-center py-8">
            ...
            <h3 className="text-xl font-semibold text-primary mb-2">Story Created!</h3>
            <p className="text-muted-foreground">
              The story has been successfully added and saved.
            </p>
          </div>
        ) : (
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Select value={formData.status} onValueChange={(value: 'draft' | 'published') => handleSelectChange('status', value)}>
                    <SelectTrigger className="bg-background border-gray-700 focus:ring-accent">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent className="bg-card border-gray-700">
